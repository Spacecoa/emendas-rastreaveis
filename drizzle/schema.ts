...
export const municipalities = mysqlTable(
  "municipalities",
  {
    ...
    populationSource: varchar("populationSource", { length: 160 }),
    populationSourceUrl: text("populationSourceUrl"),
    populationExtractedAt: timestamp("populationExtractedAt"),
    populationRecordHash: varchar("populationRecordHash", { length: 64 }),
    source: varchar("source", { length: 160 }).notNull(),
    sourceUrl: text("sourceUrl").notNull(),
    extractedAt: timestamp("extractedAt").notNull(),
    recordHash: varchar("recordHash", { length: 64 }).notNull(),
