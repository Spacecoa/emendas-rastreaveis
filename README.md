...
| Chat com os dados       | Perguntas em linguagem simples sobre a carga oficial, com fontes retornadas pelo servidor              | Usa IA apenas sobre o contexto persistido; não inventa dados, não substitui a busca e não conclui entrega física, regularidade ou irregularidade    |
