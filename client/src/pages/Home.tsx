  ...
  return <PortalLayout>
    <section className="hero-grid overflow-hidden border-b border-black/10">
      <div className="container relative py-16 sm:py-24 lg:py-28">
        <div className="absolute -right-10 top-12 size-32 rounded-full border border-[#1e4a77]/10 bg-[#b6d6f0]/25" aria-hidden="true" />
        <div className="relative max-w-4xl">
          <p className="eyebrow">REGISTROS PÚBLICOS, LEITURA CLARA</p>
          <h1 className="mt-5 max-w-3xl text-5xl font-black leading-[.92] tracking-[-0.07em] text-[#151a20] sm:text-6xl lg:text-7xl">Acompanhe a emenda <span className="font-light italic">sem pular etapas.</span></h1>
          <p className="mt-6 max-w-2xl border-l-2 border-[#1e4a77]/35 pl-5 text-lg leading-8 text-black/70">Consulte o caminho de cada emenda parlamentar — da indicação ao pagamento — e veja, com honestidade, quando ainda faltam dados para provar o resultado no município.</p>
        </div>
    ...
    <section className="container py-16 sm:py-20" aria-labelledby="cobertura-titulo">
      <div className="flex flex-wrap items-end justify-between gap-5"><div><p className="eyebrow">COBERTURA CONCRETA</p><h2 id="cobertura-titulo" className="mt-3 text-3xl font-black tracking-[-0.055em] sm:text-4xl">O que está disponível hoje.</h2><p className="mt-4 max-w-3xl leading-7 text-black/65">Estes totais vêm da carga oficial persistida. A cobertura atual é parcial e declarada: não representa o Brasil inteiro, nem prova entrega física.</p></div><Link className="inline-flex w-fit items-center gap-2 rounded-full border border-black/12 bg-white px-5 py-3 font-bold shadow-sm transition hover:bg-[#edf4fb] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#1e4a77]/35" href="/cobertura"><Search size={17} /> Ver cobertura e fontes</Link></div>
